...
# acquisition_tools.py's or analysis_tools.py's tools. Separate from
# server.py on purpose, so this agent-loop design (see loop_tools.py's
# header comment) can be tried against a real MCP client in isolation,
# without touching the already-working server.py / its tool set.
#
